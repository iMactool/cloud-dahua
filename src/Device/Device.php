<?php
    ...
    class Device extends BaseService
	{
        ...
        {
            return $this->postJosn('/gateway/device/api/page',$params);
        }
        ...
        {
            return $this->postJosn('/gateway/devicemanage/api/subEvents',$params);
        }
        ...
        {
            return $this->postJosn('/gateway/device/api/deviceInfo',$params);
        }
        ...
        {
            return $this->postJosn('/gateway/device/api/modifyDeviceInfo',$params);
        }
        ...
        public function addDevice(array $params)
        {
            ...
            return $this->postJosn('/gateway/device/api/addDevice',$params);
        }
        ...
        public function deleteDevice(string $deviceId)
        {
            ...
            return $this->postJosn('/gateway/device/api/deleteDevice',$params);
        }
        ...
        {
            return $this->postJosn('/gateway/device/api/getChannelSnap',$params);
        }
        ...
        {
            return $this->postJosn('/gateway/device/api/devicePTZInfo',$params);
        }
        ...
        {
            return $this->postJosn('/gateway/device/api/controlMovePTZ',$params);
        }
        ...
        {
            return $this->postJosn('/gateway/device/api/controlLocationPTZ',$params);
        }
