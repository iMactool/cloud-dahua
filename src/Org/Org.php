<?php
    ...
    class Org extends BaseService
	{
        ...
        {
            return $this->postJosn('/gateway/membership/api/org',$params);
        }
        ...
        {
            return $this->postJosn('/gateway/membership/api/org/list',$params);
        }
        ...
        public function deleteOrg(string $orgCode)
        {
            ...
            return $this->postJosn('/gateway/membership/api/org/'.$orgCode,$params);
        }
        ...
        {
            return $this->postJosn('/gateway/membership/api/store/add',$params);
        }
        ...
        {
            return $this->postJosn('/gateway/membership/api/store/delete',$params);
        }
        ...
        {
            return $this->postJosn('/gateway/membership/api/store/update',$params);
        }
