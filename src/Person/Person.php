<?php
	...
	namespace Imactool\DahuaCloud\Person;
    ...
    class Person extends BaseService
	{
        ...
        {
            return $this->postJosn('/gateway/person/api/houseInfo',$params);
        }
        ...
        {
            return $this->postJosn('/gateway/person/api/personFile',$params);
        }
        ...
        {
            return $this->postJosn('/gateway/person/api/personFile/page',$params);
        }
