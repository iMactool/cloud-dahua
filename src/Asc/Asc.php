<?php
    ...
    class Asc extends BaseService
	{
        ...
        {
            return $this->postJosn('/gateway/dsc-owner/api/getAuth',$params);
        }
        ...
        {
            return $this->postJosn('/gateway/dsc-owner/api/accessControl/editTimePlan',$params);
        }
        ...
        {
            return $this->postJosn('/gateway/dsc-owner/api/accessControl/setConfig/doorStatus',$params);
        }
        ...
        {
            return $this->postJosn('/gateway/dsc-owner/api/accessControl/deviceTimePlan',$params);
        }
        ...
        {
            return $this->postJosn('/gateway/dsc-owner/api/authAsync',$params);
        }
        ...
        {
            return $this->postJosn('/gateway/dsc-owner/api/accessControl/addTimePlan',$params);
        }
        ...
        public function getDoorTimePlan($timeIndex = NULL)
        {
            ...
            return $this->postJosn('/gateway/dsc-owner/api/accessControl/getTimePlan',$params);
        }
        ...
        {
            return $this->postJosn('/gateway/dsc-messagecenter/api/openDoorRecord/owner/get',$params);
        }
        ...
        {
            return $this->postJosn('/gateway/dsc-owner/api/addAuth',$params);
        }
        ...
        {
            return $this->postJosn('/gateway/dsc-owner/api/openDoor',$params);
        }
        ...
        public function batchGetDoorStatus($deviceIdList)
        {
            ...
            return $this->postJosn('/gateway/dsc-owner/api/accessControl/multiGetDoorStatus',$params);
        }
        ...
        {
            return $this->postJosn('/gateway/dsc-door/api/tempPassword/set',$params);
        }
