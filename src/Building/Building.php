<?php
    ...
    class Building extends BaseService
	{
        ...
        {
            return $this->postJosn('/gateway/membership/api/storeOrg/buildings',$params);
        }
        ...
        {
            return $this->postJosn('/gateway/membership/api/org/page',$params);
        }
        ...
        {
            return $this->postJosn('/gateway/membership/api/storeOrg/update',$params);
        }
         ...
         * @author cc
         */
        public function getBuildingRoomInfo($key)
        {
            $params = [
                'key' => $key
            ];
